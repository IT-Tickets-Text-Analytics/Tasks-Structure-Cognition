...
#____________________Choices (Adverbs)____________________________________________________
   ...
   path='C:/Users/DML_Tasks/Adverbs'
...
# ________STAGE 3. Find and count words in the Task  that match the DML Taxonomy keywords_________
                  ...
                  try:
                     ...
                     yy.append(sum([m.count(w) for w in  R_Adj_stem]))
                     #print('R_Adj=', yy[1])
                  except:
                     pass
                  try:
                  ...
                  try:
                     ...
                     yy.append(sum([m.count(w) for w in  C_Noun_stem]))
                     #print('C_Noun=', yy[6])
                     #print(yy)
                  except:
                     pass
                  try:
                     ...
                     yy.append(sum([m.count(w) for w in  R_Noun_stem]))
                     #print('R_Noun=', yy[7])
                     #print(yy)
                  except:
                     pass
